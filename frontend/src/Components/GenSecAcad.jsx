...
import { Calendar, PlusCircle, MessageSquare, DoorClosed, Award, Users, FileText, Bell, Search, Settings, ChevronRight, Layers, Grid, Home, LogOut, Book } from 'lucide-react';

const GensecAcadDashboard = () => {
  const [activeCategory, setActiveCategory] = useState('all');

  const menuItems = [
    { title: 'GenSec Acad Endorsement', path: '/gensecacad-endorse', icon: <Award className="w-5 h-5" />, category: 'endorsement', color: 'from-green-500 to-teal-600' },
    { title: 'Room Booking', path: '/roombooking', icon: <DoorClosed className="w-5 h-5" />, category: 'booking', color: 'from-blue-500 to-indigo-600' },
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="container mx-auto px-4 py-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-800">GenSec Academic Dashboard</h1>
          <p className="text-gray-600">Access and manage all your Academic services</p>
        </div>
