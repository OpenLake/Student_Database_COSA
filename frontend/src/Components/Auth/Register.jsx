...
/**
 * Render the full-page sign-up view with a Google sign-up option and CoSA branding.
 *
 * @returns {JSX.Element} The sign-up page element which includes a background image with blur and shade overlays, a centered card containing a "Sign up with Google" button (linking to `${process.env.REACT_APP_BACKEND_URL}/auth/google`), and the CoSA logo and title.
 */
