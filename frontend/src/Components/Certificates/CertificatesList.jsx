      ...
      <div className="flex-1 overflow-auto">
        {filteredCertificates.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              >
                ...
                <div className="flex gap-2 mt-auto">
                  {certificate.status === "Approved" &&
                    ...
                    <button
                    disabled
                    className="w-full px-4 py-2 bg-gray-200 text-gray-600 rounded-lg cursor-not-allowed font-medium text-sm"
                    >
                    Certificate Generated (Download Coming Soon)
                    </button>
                  ) : (
                  <>
                 <button
            ...
            className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-white border-2 border-black rounded-lg"
          > 
            <Download size={16} />
             Download
            </button>
