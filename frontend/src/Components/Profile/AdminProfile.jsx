...
//   console.log("Stats in the admin profile page are :", stats);
...
//       {/* Header */}
//       <div className="bg-gradient-to-r from-indigo-900 to-indigo-700 text-white px-6 py-4 shadow-sm flex items-center justify-between">
...
//                 icon: Phone,
//                 label: "Phone Number",
//                 value: profile.personal_info?.phone || "Not Provided",
//               },
//               {
//                 icon: Mail,
//                 label: "Username",
...
//                 label: "LinkedIn",
//                 value:
//                   profile.contact_info?.socialLinks?.linkedin ||
//                   "Not Provided",
//               },
//               {
//                 icon: Mail,
//                 label: "GitHub",
//                 value:
//                   profile.contact_info?.socialLinks?.github || "Not Provided",
//               },
//             ]}
//           />
//         </div>
...
//                 icon: Users,
//                 label: "Gender",
//                 value: profile.personal_info?.gender || "Not Provided",
//               },
//               {
//                 icon: Calendar,
//                 label: "Date of Birth",
//                 value: profile.personal_info?.date_of_birth
//                   ? new Date(profile.personal_info.date_of_birth)
//                       .toISOString()
//                       .split("T")[0]
//                   : "Not Provided",
//               },
...
//                 icon: Home,
//                 label: "Hostel Name",
//                 value: profile.contact_info?.hostel || "Not Provided",
//               },
//               {
//                 icon: MapPin,
//                 label: "Room Number",
//                 value: profile.contact_info?.room_number || "Not Provided",
//               },
//             ]}
//           />
//         </div>
...
//     <h3 className="text-sm font-bold text-indigo-700 border-b border-indigo-200 pb-1">
//       {title}
//     </h3>
//     {fields.map(({ icon: Icon, label, value }) => (
//       <div key={label} className="flex items-start gap-2 text-sm">
//         {Icon && <Icon className="w-4 h-4 text-indigo-600 mt-0.5" />}
//         <div>
