  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        // Example:
        const requestsResponse = await fetch(`${API_BASE_URL}/room/requests?status=pending`);
        ...
        <div className="bg-white rounded-xl shadow-lg mb-6 overflow-hidden">
          <div className="bg-blue-600 p-4">
            <div className="flex items-center justify-between">
              <h1 className="text-2xl md:text-3xl font-bold text-white">President Dashboard</h1>
          ...
          <div className="p-4 md:p-6">
            <p className="text-gray-600">
              Welcome to your executive control panel. Manage approvals, events, room bookings, and more from this central hub.
            </p>
          </div>
        </div>
          ...
          >
            <div className="p-5">
              <div className="flex items-center mb-3">
                ...
                <h3 className="ml-2 text-xl font-semibold text-white">Approve Requests</h3>
              </div>
              <p className="text-white text-opacity-90 text-sm">Review and approve pending requests</p>
            </div>
          ...
          >
            <div className="p-5">
              <div className="flex items-center mb-3">
                ...
                <h3 className="ml-2 text-xl font-semibold text-white">Room Booking</h3>
              </div>
              <p className="text-white text-opacity-90 text-sm">Manage facility reservations</p>
            </div>
          ...
          >
            <div className="p-5">
              <div className="flex items-center mb-3">
                ...
                <h3 className="ml-2 text-xl font-semibold text-white">View Events</h3>
              </div>
              <p className="text-white text-opacity-90 text-sm">See all upcoming and past events</p>
            </div>
          ...
          >
            <div className="p-5">
              <div className="flex items-center mb-3">
                ...
                <h3 className="ml-2 text-xl font-semibold text-white">Create Event</h3>
              </div>
              <p className="text-white text-opacity-90 text-sm">Schedule new college events</p>
            </div>
          ...
          >
            <div className="p-5">
              <div className="flex items-center mb-3">
                ...
                <h3 className="ml-2 text-xl font-semibold text-white">Create Tenure</h3>
              </div>
              <p className="text-white text-opacity-90 text-sm">Add new COSA tenure records</p>
            </div>
          ...
          >
            <div className="p-5">
              <div className="flex items-center mb-3">
                ...
                <h3 className="ml-2 text-xl font-semibold text-white">View COSA Records</h3>
              </div>
              <p className="text-white text-opacity-90 text-sm">Access complete COSA documentation and tenure history</p>
            </div>
              ...
              <div className="divide-y divide-gray-100">
                {recentActivities.map((activity, index) => (
                  <div key={index} className="py-3 flex items-center">
                    <div className={`bg-${activity.type}-100 p-2 rounded-full mr-3`}>
                      {/* Render different icons based on activity type */}
                      {activity.type === 'approval' && (
                        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 text-${activity.type}-600`} viewBox="0 0 20 20" fill="currentColor">
