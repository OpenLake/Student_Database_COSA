...
const FeedbackForm = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 p-6">
      <form
        className="bg-white shadow-lg rounded-lg p-8 w-full max-w-2xl flex flex-col gap-6 border border-blue-200"
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <select
            className="w-full p-3 border border-blue-300 rounded-lg bg-white text-blue-800 text-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            className="w-full h-32 bg-white p-4 border border-blue-300 rounded-lg text-lg text-blue-800 resize-none focus:outline-none focus:ring-2 focus:ring-blue-400"
