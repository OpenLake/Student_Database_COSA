...
const ViewFeedback = () => {
  ...
  const fetchFeedback = async () => {
    setLoading(true);
    try {
      const res = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/feedback`);
  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-600">Browse through student suggestions, complaints, and queries</p>
      </div>
        ...
        <div>
          {filteredFeedbacks.length === 0 ? (
            <div className="bg-gray-50 p-10 text-center rounded-xl shadow-sm border border-gray-100">
              ...
              <p className="text-xl text-gray-600 mb-4">No feedback available</p>
              <button 
