...
const GensecCultDashboard = () => {
  ...
  const menuItems = [
    { title: 'GenSec Cultural Endorsement', path: '/genseccult-endorse', icon: <Award className="w-5 h-5" />, category: 'endorsement', color: 'from-purple-500 to-pink-600' },
  ...
  return (
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link 
                to="/login" 
                className="flex items-center px-3 py-1.5 bg-purple-800 hover:bg-purple-900 rounded-lg transition-colors"
              >
      ...
      <main className="container mx-auto px-4 py-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-800">GenSec Cultural Dashboard</h1>
          <p className="text-gray-600">Access and manage all your Cultural services</p>
        </div>
