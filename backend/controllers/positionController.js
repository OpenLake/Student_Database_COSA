...
exports.getAllPositionHolders =
  async (req, res) => {
    try {
      ...
      return res.status(500).json({
        message:
          "Error fetching position holders.",
      });
    }
  };

// Get Position Holder By User
exports.getPositionHolderByUser =
  async (req, res) => {
    ...
    try {
      ...
      return res.status(500).json({
        message:
          "Error fetching position holder.",
      });
    }
  };